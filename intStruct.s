	...
	.globl	__Z11init_StructP12SingleStruct ## -- Begin function _Z11init_StructP12SingleStruct
	.p2align	4, 0x90
__Z11init_StructP12SingleStruct:        ## @_Z11init_StructP12SingleStruct
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	...
	.cfi_endproc
                                        ## -- End function
	.globl	__Z10print_dataP12SingleStruct  ## -- Begin function _Z10print_dataP12SingleStruct
	.p2align	4, 0x90
__Z10print_dataP12SingleStruct:         ## @_Z10print_dataP12SingleStruct
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
## %bb.0:
	...
	.cfi_endproc
                                        ## -- End function
	.globl	__Z13multiply_dataP12SingleStructi ## -- Begin function _Z13multiply_dataP12SingleStructi
	.p2align	4, 0x90
__Z13multiply_dataP12SingleStructi:     ## @_Z13multiply_dataP12SingleStructi
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
## %bb.0:
	...
	movl	$10, -20(%rbp)
	movq	-16(%rbp), %rdi
	callq	__Z11init_StructP12SingleStruct
	movq	-16(%rbp), %rdi
	callq	__Z10print_dataP12SingleStruct
	movq	-16(%rbp), %rdi
	movl	-20(%rbp), %esi
	callq	__Z13multiply_dataP12SingleStructi
...
L_.str:                                 ## @.str
	.asciz	" is the value at the address : "
