	...
	.globl	__ZN12randomStruct10initializeEv ## -- Begin function _ZN12randomStruct10initializeEv
	.p2align	4, 0x90
__ZN12randomStruct10initializeEv:       ## @_ZN12randomStruct10initializeEv
	.cfi_startproc
## %bb.0:
	pushq	%rbp
...
## %bb.0:
	...
	movl	$0, -4(%rbp)
	leaq	-8(%rbp), %rdi
	callq	__ZN12randomStruct10initializeEv
	xorl	%eax, %eax
	addq	$16, %rsp
	popq	%rbp
	retq
